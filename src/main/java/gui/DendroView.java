...
import gui.labels.ColumnFinderBox;
import gui.labels.ColumnLabelView;
import gui.labels.LabelFinderBox;
import gui.labels.LabelView;
import gui.labels.RowFinderBox;
import gui.labels.RowLabelView;
import gui.matrix.DendroPanel;
import gui.matrix.GlobalMatrixView;
import gui.matrix.InteractiveMatrixView;
import gui.matrix.MapContainer;
import gui.matrix.ModelView;
import gui.trees.ColumnTreeView;
import gui.trees.RowTreeView;
import gui.trees.TRView;
 ...
 * that model. If you want to show another file, make another gui.dendroview. All
...
//	private JButton exportBtn;
	...
	// @Override
	// public void model.export(final MainProgramArgs mainArgs) throws ExportException
	// {
	//
	...
	/**
	 * Get an image of the row tree for the model.export preview
	 * 
	 * @param withSelections - Whether to include selection highlighting
	 * @param region - region of the matrix to model.export
	 * @return
	 */
	...
	/**
	 * Get an image of the col tree for the model.export preview
	 * 
	 * @param withSelections - Whether to include selection highlighting
	 * @param region - region of the matrix to model.export
	 * @return
	...
	/**
	 * Get an image of the row labels for the model.export preview
	 * 
	 * @param withSelections - Whether to include selection highlighting
	 * @param region - region of the matrix to model.export
	 * @param width - preview image width
	...
	/**
	 * Get an image of the column labels for the model.export preview
	 * 
	 * @param withSelections - Whether to include selection highlighting
	 * @param region - region of the matrix to model.export
	 * @param width - preview image width
	...
	/**
	 * Get an image of a tree for the model.export preview
	 * 
	 ...
	 * @param realWidth - model.export image width
	 * @param realHeight - model.export image height
	 * @param isRows - Whether this is for a row tree or not
	 */
	...
	/**
	 * Get a labels pane snapshot for the model.export preview
	 * 

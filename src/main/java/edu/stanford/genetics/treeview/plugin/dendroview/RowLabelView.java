...
public class RowLabelView extends LabelView {
	...
	protected void setLabelPaneSize(int offscreenPrimarySize, int offscreenSecondarySize) {
		...
		setPreferredSize(new Dimension(offscreenSecondarySize, offscreenPrimarySize));
		debug("Resizing row labels panel to [" + offscreenSecondarySize + "x" + offscreenPrimarySize + "].", 2);
	}

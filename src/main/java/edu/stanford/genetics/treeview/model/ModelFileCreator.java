...
//		}
//
//		String rootFileName = ModelFileCreator.getRootFileName(fileNameP
//																																			.toString());
//		final String rootDir = findRootDir(defaultDirP, rootFileName) +
//														File.separatorChar;
//		final String linkName = ModelFileCreator.getLinkName(linkMethod);
//		final String subDir = ModelFileCreator.createSubDir(rootDir, linkName);
//
...
//	}
	...
	public static String determineClusterFileExt(	final boolean isClustered,

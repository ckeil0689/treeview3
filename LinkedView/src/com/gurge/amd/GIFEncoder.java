...
public class GIFEncoder {
	 ...
	 * */
	public GIFEncoder(final Image image) throws AWTException {

		width_ = (short) image.getWidth(null);
		height_ = (short) image.getHeight(null);

		final int values[] = new int[width_ * height_];

		final PixelGrabber grabber = new PixelGrabber(image, 0, 0, width_,
				height_, values, 0, width_);
		...
		final byte r[][] = new byte[width_][height_];
		final byte g[][] = new byte[width_][height_];
		final byte b[][] = new byte[width_][height_];
	 ...
	 * */
	public GIFEncoder(final byte r[][], final byte g[][], final byte b[][])
			throws AWTException {
	...
	public void Write(final OutputStream output) throws IOException {
		...
		final ScreenDescriptor sd = new ScreenDescriptor(width_, height_,
				numColors_);
		sd.Write(output);
	...
	public void ToIndexedColor(final byte r[][], final byte g[][],
			final byte b[][]) throws AWTException {
		...
		final byte copy[] = new byte[numColors_ * 3];
...
class BitFile {
	...
	public BitFile(final OutputStream output) {
	...
	public void Flush() throws IOException {
		...
		final int numBytes = index_ + (bitsLeft_ == 8 ? 0 : 1);
...
class LZWCompressor {
	...
	public static void LZWCompress(final OutputStream output,
			final int codesize, final byte toCompress[]) throws IOException {
		byte c;
		short index;
		int clearcode, endofinfo, numbits, limit;
		short prefix = (short) 0xFFFF;

		final BitFile bitFile = new BitFile(output);
		final LZWStringTable strings = new LZWStringTable();
...
class ScreenDescriptor {
	...
	public ScreenDescriptor(final short width, final short height,
			final int numColors) {
...
class ImageDescriptor {
	...
	public ImageDescriptor(final short width, final short height,
...
class BitUtils {
	...
	public static void WriteWord(final OutputStream output, final short w)
			throws IOException {
		output.write(w & 0xFF);

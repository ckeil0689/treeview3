 ...
 * a useful addition. It would be nice if significant contributions could 
...
public interface ConfigNodePersistent {
	 ...
	 * It accepts a parent node as parameter so the new node can be added
	 * to the exisiting hierarchy of Preferences nodes. The node will be a child 

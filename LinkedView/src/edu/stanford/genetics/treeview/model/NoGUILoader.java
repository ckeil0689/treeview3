...
public class NoGUILoader {
	...
	public NoGUILoader(final DataModel model) {
	...
	public TVModel load() throws OutOfMemoryError {
		...
		try { 
			...
			LogBuffer.println("Getting file ready to load...");
			...
			try {
				...
				LogBuffer.println("Extracting data.");

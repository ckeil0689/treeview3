...
/**
 * average by neighbors. k must be an odd integer. Returns the average of the
 * locus, the (k-1)/2 loci on the left, and the (k-1)/2 loci on the right.
 */
class NeighborAverager extends GroupAverager {
	...
	public NeighborAverager(final int n) {
		setNum(n);
	}

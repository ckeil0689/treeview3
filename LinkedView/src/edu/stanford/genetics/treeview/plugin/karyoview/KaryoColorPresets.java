...
public class KaryoColorPresets {
	 ...
	 */
	public KaryoColorPresets(final ConfigNode parent) {
		super();
		bindConfig(parent);
	...
	static {
		...
		defaultColorSets[0] = new KaryoColorSet("BlackBG", "#FF0000",
				"#00FF00", "#FFFF00", "#FFFFFF", "#000000", "#A0A0A0");
		defaultColorSets[1] = new KaryoColorSet("WhiteBG", "#FF0000",
				"#00FF00", "#FFFF00", "#000000", "#FFFFFF", "#A0A0A0");
	}
	...
	public String[] getPresetNames() {
		final ConfigNode aconfigNode[] = root.fetch("KaryoColorSet");
		final String astring[] = new String[aconfigNode.length];
		final KaryoColorSet temp = new KaryoColorSet("TempColorSet");
	...
	public String toString() {
		final ConfigNode aconfigNode[] = root.fetch("KaryoColorSet");
		final KaryoColorSet tmp = new KaryoColorSet();
	 ...
	 * thrown.
	 */
	public KaryoColorSet getColorSet(final int index) {
		final ConfigNode aconfigNode[] = root.fetch("KaryoColorSet");
		try {
			final KaryoColorSet ret = new KaryoColorSet();
	 ...
	 */
	public KaryoColorSet getColorSet(final String name) {
		final ConfigNode aconfigNode[] = root.fetch("KaryoColorSet");
		final KaryoColorSet ret = new KaryoColorSet();
		for (int i = 0; i < aconfigNode.length; i++) {
	 ...
	 * copy.
	 */
	public void addColorSet(final KaryoColorSet set) {
		final KaryoColorSet preset = new KaryoColorSet("AddingColorSet");

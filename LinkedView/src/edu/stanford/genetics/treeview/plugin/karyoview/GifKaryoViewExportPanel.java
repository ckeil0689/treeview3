...
class GifKaryoViewExportPanel extends KaryoViewExportPanel {
	GifKaryoViewExportPanel(final KaryoView scatterView) {
		super(scatterView);
	}
	...
	public void save() {
		try {
			...
			LogBuffer.println("GIF KaryoView Export Panel caught exception "
					+ e);
		}
	}
	...
	public void write(final OutputStream output) {
		...
		try {
			...
			LogBuffer
					.println("In GifKaryoViewExportPanel.synchronizeTo() got exception "
							+ e);
		}
	}
}

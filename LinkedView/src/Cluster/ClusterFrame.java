...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~New Panels~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    
	...
	//					clusterfileMru.notifyObservers();
	    	...
	    	//buttonPane2.setBackground(Color.CYAN);
		...
		private static final long serialVersionUID = 1L;
			...
			JButton info_button;
			  ...
			  public RemovePercentPanel() {
		    	...
		    	//bPane.setBackground(Color.GREEN);
	  ...
	  class AdjustOptionsPanel extends JPanel {	
			...
			public AdjustOptionsPanel() {
				...
				logPanel.setBorder(BorderFactory.createTitledBorder("Log Transform"));
		...
		class ClusterOptionsPanel extends JPanel {	
			...
			JButton centroid_button, single_button, complete_button, average_button;
				 ...
				 public ClusterOptionsPanel() {
					...
					this.add(geneClusterPanel, "grow, push, split 2");
					
					//Component 2
					arrayClusterPanel = new ArrayClusterPanel();
					this.add(arrayClusterPanel, "grow, push, wrap");
			    	...
			    	this.add(buttonPanel, "alignx 50%, grow, push");
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	* 
	*/
	private void hCluster(int method, double[] currentArray, String similarityM) {

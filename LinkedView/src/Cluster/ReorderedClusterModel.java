 ...
 *
 */
public class ReorderedClusterModel extends Observable implements DataModel {
	/**
	 * @author aloksaldanha
	 *
	 */
	 ...
	 * @param geneIndex
	 */
	public ReorderedClusterModel(DataModel source, int [] geneIndex) {
	 ...
	 * @param geneIndex
	 */
	public ReorderedClusterModel(DataModel source, int [] geneIndex, int [] arrayIndex) {

<?php
/* $Id: config.inc.php,v 1.1 2004-12-05 20:16:29 alokito Exp $ */
 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://jtreeview.sourceforge.net/phpMyAdmin';
...
$cfg['Servers'][$i]['user']          = 'jtreeview';      // MySQL user
$cfg['Servers'][$i]['password']      = '';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'jtreeview';          // If set to a db-name, only
